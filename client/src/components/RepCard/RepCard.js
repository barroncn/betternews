...
const RepCard = props =>
  ...
  <div className="card rep text-center">
            ...
            <div className="rep-card-body card-body">
              ...
              <p className="card-text">{props.repState} - {(props.party === "D") ? "Democrat" : "Republican"}</p>
              <p>
                ...
                <a href={"/details/" +props.apiID} target="_blank" className="card-title font-weight-bold"> 
